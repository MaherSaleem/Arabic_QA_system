...
public class PassageSegmentation {
    ...
    public static ArrayList<String> getDocumentSegments(int documentId, String questionText, String splitRegex) {

        splitRegex = splitRegex != null ? splitRegex : "[؟?!.]";


        String documentText = PassageSegmentation.getDocumentText(documentId);
        String[] keyPhrases = PassageSegmentation.getQueryKeyPhrases(questionText);
